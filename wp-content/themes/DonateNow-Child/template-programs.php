	     			...
	     			while ( $loop->have_posts() ) : $loop->the_post();
							...
							if($link=="permalink"){ ?>
									...
									<?php } else if($columns=="3") {  $columnidisotop = "3"; ?>
										<div class="port port-file-3 span4 sorting <?php $post_cats = wp_get_post_terms( $post->ID,'product_cat' ); foreach( $post_cats as $category ) { echo $category->slug.' ';} ?>" data-category="portfolio">
