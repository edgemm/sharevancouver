...
if ( $order->status == 'pending' )
	echo sprintf( __( 'An donation has been created for you on %s. To pay for this donation please use the following link: %s', 'woocommerce' ), get_bloginfo( 'name' ), $order->get_checkout_payment_url() ) . "\n\n";
