...
echo sprintf( __( "Hi there. Your recent donation on %s has been completed. We at %s are continually inspired by the dedication and generosity of donors like you who answer the call to help those we serve, especially the children. Thank you. Your donation details are shown below for your reference:", 'woocommerce' ), get_option( 'blogname' ) ) . "\n\n";
