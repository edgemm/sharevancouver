...
<header id="header">
			<div class="container">
				<div class="row">
                    ...
                    <!--smc header menu-->
<div id="preload"><img src="/wp-content/themes/DonateNow-Child/images/shop2_hover.png" width="1" height="1" alt="Image 01" /></div>
<?php global $woocommerce; ?>
<div class="header-menu">
<a href="/contact-us/">Contact Us</a> / <a href="/my-account/">My Account</a><?php if ( sizeof( $woocommerce->cart->cart_contents ) !== 0 ) { ?> / <a href="/cart/">Cart <span id="header-cart"></span></a><?php } ?></div>
<!--end smc header menu-->
		 ...
		 <div id="nav"> 
			...
			<div class="container">
				<div class="row">
					...
					<div class="<?php echo "span12"; ?>"><?php mt_menu(); ?>
                    <!--<span id="smc-cart"><a href="/cart/">Cart</a></span> -->
					</div>
		...
		<div class="mt-shadow"> 
			<div class="container" > 
				<div class="row  mt-title">
					...
					<?php if (is_product()){ ?>
                    <?php global $post, $product; $categ = $product->get_categories(); ?> 
						
						<div class="span8"><h1><?php echo $categ; ?></h1></div>
...
<?php if(is_page(738)){ ?><span id="gifts-of-hope-bar"></span><?php } ?>
